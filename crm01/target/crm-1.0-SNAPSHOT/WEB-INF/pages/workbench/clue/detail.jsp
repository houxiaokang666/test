		...
		<c:forEach items="${requestScope.clueRemarks}" var="clueRemark">
			<div class="remarkDiv" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">线索</font> <font color="gray">-</font> <b>${requestScope.clue.fullname}-${requestScope.clue.appellation}</b> <small style="color: gray;"> ${clueRemark.editFlag=="1"?clueRemark.editTime:clueRemark.createTime} 由${clueRemark.editFlag=="1"?clueRemark.editBy:clueRemark.createBy}${clueRemark.editFlag=="1"?"修改":"创建"}</small>
