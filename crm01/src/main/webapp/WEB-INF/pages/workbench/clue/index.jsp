...
<!-- 创建线索的模态窗口 -->
<div class="modal fade" id="createcreateModal" role="dialog">
    <div class="modal-dialog" role="document" style="width: 90%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="create-from" role="form">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" id="createClose" data-dismiss="modal">关闭</button>
                <button type="button" class="btn btn-primary" id="createSave">保存</button>
            </div>
        </div>
    </div>
</div>
...
<!-- 修改线索的模态窗口 -->
<div class="modal fade" id="editcreateModal" role="dialog">
    <div class="modal-dialog" role="document" style="width: 90%;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="edit-createOwner" class="col-sm-2 control-label">所有者<span
                                style="font-size: 15px; color: red;">*</span></label>
                        <div class="col-sm-10" style="width: 300px;">
                            <select class="form-control" id="edit-createOwner">
                                <c:forEach items="${requestScope.users}" var="u">
                                    <option value="${u.id}">${u.name}</option>
                                </c:forEach>
                            </select>
            ...
            <form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <select class="form-control">
                            <c:forEach items="${requestScope.createState}" var="cs">
                                <option value="${cs.id}">${cs.value}</option>
                            </c:forEach>
                        </select>
                    </div>
        ...
        <div class="btn-toolbar" role="toolbar"
            ...
            <div class="btn-group" style="position: relative; top: 18%;">
                <button type="button" id="create-button" class="btn btn-primary" data-toggle="modal"
                        data-target="#createcreateModal"><span class="glyphicon glyphicon-plus"></span> 创建
                </button>
                <button type="button" class="btn btn-default" data-toggle="modal" data-target="#editcreateModal"><span
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td><a style="text-decoration: none; cursor: pointer;"
                           onclick="window.location.href='workbench/clue/toClueDetail.do?ClueId=083579b1691c45ae9ab39457ec95fd1a';">李四先生</a>
                    </td>
                    <td>动力节点</td>
                    <td>010-84846003</td>
                    <td>12345678901</td>
