    ...
    <script type="text/javascript">
        $(function () {
            $("#convertbtn").click(function () {
                ...
                var isCreatedTean = $("#isCreateTransaction").prop("checked");
            ...
            $("#searchActivity").keyup(function () {
                ...
                $.ajax({
                    url: "workbench/clue/SelectSourcesOfMarketingActivity.do",
                    data: {
                        clueId: clueId,
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (index, obj) {
                            str += "<tr>";
                            str += "<td><input type=\"radio\" VALUE=\"" + obj.id + "\" activityName=\"" + obj.name + "\" name=\"activity\"/></td>";
                            str += "<td>" + obj.name + "</td>";
                ...
                <div class="btn-group" style="position: relative; top: 18%; left: 8px;">
                    <form class="form-inline" role="form">
                        <div class="form-group has-feedback">
                            <input type="text" id="searchActivity" class="form-control" style="width: 300px;"
