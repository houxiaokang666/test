...
<div style="position:  relative; left: 30px;">
    ...
    <div style="position: relative; top: -40px; left: 70%;">
        <button type="button" id="saveCreated" class="btn btn-primary">保存</button>
...
<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
    <div class="form-group">
        <label for="created-owner" class="col-sm-2 control-label">所有者<span style="font-size: 15px; color: red;">*</span></label>
        ...
        <label for="created-money" class="col-sm-2 control-label">金额</label>
        <div class="col-sm-10" style="width: 300px;">
    ...
    <div class="form-group">
        <label for="created-name" class="col-sm-2 control-label">名称<span
                style="font-size: 15px; color: red;">*</span></label>
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="created-name">
        </div>
        <label for="created-expectedDate" class="col-sm-2 control-label">预计成交日期<span
                style="font-size: 15px; color: red;">*</span></label>
        <div class="col-sm-10" style="width: 300px;">
    ...
    <div class="form-group">
        <label for="created-customerId" class="col-sm-2 control-label">客户名称<span
                style="font-size: 15px; color: red;">*</span></label>
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="created-customerId" placeholder="支持自动补全，输入客户不存在则新建">
        </div>
        <label for="created-stage" class="col-sm-2 control-label">阶段<span style="font-size: 15px; color: red;">*</span></label>
        <div class="col-sm-10" style="width: 300px;">
    ...
    <div class="form-group">
        <label for="created-type" class="col-sm-2 control-label">类型</label>
        <div class="col-sm-10" style="width: 300px;">
    ...
    <div class="form-group">
        <label for="created-source" class="col-sm-2 control-label">来源</label>
        <div class="col-sm-10" style="width: 300px;">
    ...
    <div class="form-group">
        <label for="created-contactsId" class="col-sm-2 control-label">联系人名称&nbsp;&nbsp;<a href="javascript:void(0);"
                                                                                           data-toggle="modal"
    ...
    <div class="form-group">
        <label for="created-description" class="col-sm-2 control-label">描述</label>
    ...
    <div class="form-group">
        <label for="created-contactSummary" class="col-sm-2 control-label">联系纪要</label>
        <div class="col-sm-10" style="width: 70%;">
    ...
    <div class="form-group">
        <label for="created-nextContactTime" class="col-sm-2 control-label">下次联系时间</label>
        <div class="col-sm-10" style="width: 300px;">
